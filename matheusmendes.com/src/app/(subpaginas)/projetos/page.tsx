  ...
  return (
    <>
      ...
      <main className='flex flex-col items-center'>
        <Bar />
        <section className='flex flex-wrap justify-center gap-8 items-center animate-title  w-full'>
                ...
                <CardProject.Root key={id}>
                 <main className='flex flex-col gap-4 w-full'>
                  <section className='mt-auto'>
                    ...
                    <section className='flex items-center justify-start gap-3 lg:w-[500px] flex-wrap ' >
                      {
                        language &&
