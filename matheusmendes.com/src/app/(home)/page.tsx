  ...
  return (
    <>
      ...
      />
        ...
        <main className="">
          <h1 className="  w-full sm:w-[35rem] h-[7.4375rem] sm:text-9xl text-4xl font-bold font-['Inter'] leading-[94.72px] tracking-[4.85px] text-center text-white" title={`Olá, sou o Matheus`}>{data.mainText.content}</h1>
        </main>
