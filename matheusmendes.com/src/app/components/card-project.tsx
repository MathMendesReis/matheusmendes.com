...
export default function CardProject({id,created_at,description,html_url,name}:Props) {
  return (
    <Link href={html_url ? html_url : ''} target='_blank' key={id} className=" sm:w-[23rem] w-full h-[12rem] bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-md p-4 flex flex-col gap-1">
      <header>
